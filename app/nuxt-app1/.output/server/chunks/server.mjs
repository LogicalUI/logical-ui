...
const components = {};
function componentsPlugin_4183c888(nuxtApp) {
...
const vueuseHead_03873eca = defineNuxtPlugin((nuxtApp) => {
...
const _f0d06a84 = defineNuxtPlugin((nuxtApp) => {
...
const _7fb8b841 = defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-04d6a107><div class="fixed left-0 right-0 spotlight z-10" data-v-04d6a107></div><div class="max-w-520px text-center z-20" data-v-04d6a107><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-04d6a107>${serverRenderer.exports.ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-04d6a107>${serverRenderer.exports.ssrInterpolate(__props.description)}</p><div class="w-full flex items-center justify-center" data-v-04d6a107>`);
...
const Error404 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-04d6a107"]]);
const _sfc_main$5 = {
  __ssrInlineRender: true,
  props: {
    appName: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-5986653b><div class="fixed -bottom-1/2 left-0 right-0 h-1/2 spotlight" data-v-5986653b></div><div class="max-w-520px text-center" data-v-5986653b><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-5986653b>${serverRenderer.exports.ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-5986653b>${serverRenderer.exports.ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
const Error500 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-5986653b"]]);
const _sfc_main$3 = {
  __ssrInlineRender: true,
  props: {
    error: Object
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui-templates@0.1.1/node_modules/@nuxt/ui-templates/dist/templates/welcome.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-973a9a70"]]);
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtWelcome = __nuxt_component_0;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><div>\u8FD9\u662F app1111\u5566\u5566\u62C9</div>`);
